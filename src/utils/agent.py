...
class Agent:
    ...
    def __init__(self, env, obs_space, action_space, model_dir, ignoreLTL, progression_mode,
                gnn, recurrence = 1, dumb_ac = False, device=None, argmax=False, num_envs=1, args=None):
        try:
            print(model_dir)
        ...
        using_gnn = (gnn != "GRU" and gnn != "LSTM" and gnn != "Transformer")
        ...
        if recurrence > 1:
            ...
            self.acmodel = ACModel(env, obs_space, action_space, ignoreLTL, gnn, dumb_ac, True, args)
