    ...
    def update_parameters(self, exps):
        ...
        for _ in range(self.epochs):  # 10
            ...
            for inds in self._get_batches_starting_indexes():
                # inds is a number list, which length is 1024 (default batch size)
                ...
                for i in range(self.recurrence):  # range(1) means i = 0
                    # Create a sub-batch of experience

                    sb = exps[inds + i]  # len(DictList) = 1024
                    ...
                    if self.acmodel.recurrent:
                        ...
                        # dist: Normal(loc: torch.Size([1024, 2]), scale: torch.Size([1024, 2])); value: (1024,)
                    ...
                    value_loss = torch.max(surr1, surr2).mean()  # todo: Understand
